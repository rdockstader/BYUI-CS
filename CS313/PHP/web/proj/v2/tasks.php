...
<?php
    ...
    if(isset($_SESSION['userid']) && isset($_GET['taskgroupid'])) {
        ...
        $getTasks = $db->prepare('SELECT * FROM ttasks WHERE userid=:userid AND taskgroupid=:taskgroupid AND completeddate IS NULL');
                    ...
                    <div class="collapse" id="addNewTask">
                        <div class="card card-body">
                            <form action="insertTask.php" method="post">
                                ...
                                <input type="text" value="<?php echo $_GET['taskgroupid'] ?>" name="taskgroupid" hidden>
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <form action="completeTask.php">
                                            <input type="text" name="taskid" value=" <?php echo $task['taskid'] ?>" hidden>
                                            <input type="text" name="taskgroupid" value=" <?php echo $_GET['taskgroupid'] ?>" hidden>
